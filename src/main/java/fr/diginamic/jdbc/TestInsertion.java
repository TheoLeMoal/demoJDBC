	...
	public static void main(String[] args) {
		...
		try {
			...
			try {
				...
				System.out.println("Insertion d'une donné dans la base de données 'compta' réussie.");
				
			} catch (Exception e) {
				System.err.println("Erreur lors de l'nsertion d'une donné dans la base de données 'compta'" + e.getMessage());
			}
